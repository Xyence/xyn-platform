...
const PANEL_IDENTITY_RULES: Record<PanelType, PanelIdentityRule> = {
  ...
  campaign_list: { object_type: "workspace", requires_thread: false },
  campaign_detail: { object_type: "campaign", requires_thread: false },
  ...
  solution_list: { object_type: "workspace", requires_thread: false },
  solution_detail: { object_type: "application", requires_thread: false },
